...
Для введения новых особенностей использовалась анимация на CSS, стандартные фильтры изображений (увеличение яркости при наведении).
...
Приведем пример.  
Пусть пользователь находится в списке тредов топика "Mathematics". Теперь он хочет перейти в тред "Diff-eq" и кликает на соответвующую ссылку.
